...
* [samgeo](https://github.com/opengeos/segment-geospatial/) segment anything sur du spatial / et [Geometric-Attributes-Toolbox](https://github.com/BjornNyberg/Geometric-Attributes-Toolbox) sont plugin Qgis ! (mais qui fait aussi d'autre choses )
